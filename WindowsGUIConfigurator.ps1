        ...
        <TabControl HorizontalAlignment="Left" Height="363" Margin="15,164,0,0" VerticalAlignment="Top" Width="517">
            <TabItem Header="Quick Access" FontSize="14">
                <Grid Background="#FFE5E5E5">
                    ...
                    <Button x:Name="btnPowerMgmt" Content="Power Mgmt" HorizontalAlignment="Left" Margin="10,81,0,0" VerticalAlignment="Top" Width="181" Height="30" FontSize="14"/>
                    <Button x:Name="btnNetworkInfo" Content="Network Settings" HorizontalAlignment="Left" Margin="10,115,0,0" VerticalAlignment="Top" Width="181" Height="30" FontSize="14"/>
                    <Button x:Name="btnNetworkInterfaces" Content="Network Interfaces" HorizontalAlignment="Left" Margin="10,0,0,0" VerticalAlignment="Center" Width="181" Height="30" FontSize="14"/>
                    ...
                    <Button x:Name="btnTaskmgr" Content="TaskMgr" HorizontalAlignment="Left" Margin="10,187,0,0" VerticalAlignment="Top" Width="181" Height="30" FontSize="14"/>
                    <Button x:Name="btnWindowsUpdates" Content="Windows Updates" HorizontalAlignment="Left" Margin="10,223,0,0" VerticalAlignment="Top" Width="181" Height="30" FontSize="14"/>
                </Grid>
            </TabItem>
...
$WPFbtnNetworkInfo.Add_Click({ 
  # Start-Process "control /name Microsoft.NetworkAndSharingCenter"
